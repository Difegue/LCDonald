...
#if BURGER
        public override string ShortName => "magicbattle";
        public override string Name => "Bat Magic's Magic Battle";
#else
        ...
        public override List<LCDGameInput> GetAvailableInputs()
        {
            return new List<LCDGameInput>()
            {
                new LCDGameInput
                {
                    Name = "Left",
#if BURGER
                    Description = "Move Bat Magic Left",
#else
                ...
                new LCDGameInput
                {
                    Name = "Right",
#if BURGER
                    Description = "Move Bat Magic Right",
#else
